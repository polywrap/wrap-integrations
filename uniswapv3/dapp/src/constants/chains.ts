import ethereumLogoUrl from 'logos/ethereum-logo.png'
import arbitrumLogoUrl from 'logos/arbitrum_logo.svg'
import optimismLogoUrl from 'logos/optimistic_ethereum.svg'
import polygonMaticLogo from 'logos/polygon-matic-logo.svg'
...
export const CHAIN_INFO: ChainInfoMap = {
  ...
  [SupportedChainId.OPTIMISM]: {
    ...
    blockWaitMsBeforeWarning: 25 * 60000,
  ...
  [SupportedChainId.ARBITRUM_RINKEBY]: {
    networkType: NetworkType.L2,
    blockWaitMsBeforeWarning: 10 * 60000,
    bridge: 'https://bridge.arbitrum.io/',
    docs: 'https://offchainlabs.com/',

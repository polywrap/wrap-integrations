...
use ethers_core::{
    abi::{
        ...
        AbiParser, Error, ParamType, Token,
    },
    types::{transaction::request::TransactionRequest, Address, Bytes, NameOrAddress, H160},
    utils::to_checksum,
};
use regex::Regex;
use std::str::FromStr;

pub fn tokenize_str_args(
...
pub fn encode_function_args(method: &str, args: Vec<String>) -> Result<Bytes, Error> {
    ...
    let tokenized_args: Vec<Token> = tokenize_str_args(
        function
            .inputs
            .clone()
            .into_iter()
...
pub fn contract_call_to_tx(
    address: &str,
    method: &str,
    args: Option<Vec<String>>,
) -> super::wrap::imported::SignerTxRequest {

...
pub async fn exec_cat_async(ipfs_provider: &str, cid: &str, timeout: u32) -> Result<Vec<u8>, String> {
    exec_cat(ipfs_provider, cid, timeout).map_err(|e| build_exec_error(ipfs_provider, timeout, &e))
}

 ...
 */
var BatchSpanProcessor = /** @class */ (function () {
    ...
    BatchSpanProcessor.prototype.forceFlush = function () {
        if (this._isShutdown) {
    ...
    // does nothing.
    BatchSpanProcessor.prototype.onStart = function (_span) { };
    BatchSpanProcessor.prototype.onEnd = function (span) {
        if (this._isShutdown) {
            return;
        }
        this._addToBuffer(span);
    };
    BatchSpanProcessor.prototype.shutdown = function () {
        var _this = this;
        if (this._isShutdown) {
            return this._shuttingDownPromise;
        }
    ...
    BatchSpanProcessor.prototype._addToBuffer = function (span) {
     ...
     * */
    BatchSpanProcessor.prototype._flushAll = function () {
        var _this = this;
    ...
    BatchSpanProcessor.prototype._flushOneBatch = function () {
        var _this = this;
        this._clearTimer();
    ...
    BatchSpanProcessor.prototype._maybeStartTimer = function () {
        var _this = this;
    ...
    BatchSpanProcessor.prototype._clearTimer = function () {
        if (this._timer !== undefined) {

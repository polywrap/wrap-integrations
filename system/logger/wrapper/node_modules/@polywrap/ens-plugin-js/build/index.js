...
exports.plugin = exports.ensPlugin = exports.EnsPlugin = void 0;
...
var EnsPlugin = /** @class */ (function (_super) {
    ...
    EnsPlugin.prototype.tryResolveUri = function (input, client) {
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    ...
                    case 1:
                        _a.trys.push([1, 3, , 4]);
                        return [4 /*yield*/, this.ensToCID(input.path, client)];
                    case 2:
                        cid = _a.sent();
                        if (!cid) {
                            return [2 /*return*/, null];
    ...
    EnsPlugin.prototype.getFile = function (_input, _client) {
        return null;
    };
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        ...
                        ensAddress = EnsPlugin.defaultAddress;
    ...
    EnsPlugin.prototype._setAddresses = function (addresses) {
        var e_3, _a;
    ...
    EnsPlugin.defaultAddress = "0x00000000000C2E074eC69A0dFb2997BA6C7d2e1e";
    return EnsPlugin;
}(wrap_1.Module));
exports.EnsPlugin = EnsPlugin;
exports.ensPlugin = function (opts) {
    return {
        factory: function () { return new EnsPlugin(opts); },
        manifest: wrap_1.manifest,
    };
};
exports.plugin = exports.ensPlugin;

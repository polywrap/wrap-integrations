...
export declare abstract class Module<TConfig extends Record<string, unknown>> extends PluginModule<TConfig> {
    abstract toAscii(input: Input_toAscii, client: Client): MaybeAsync<Types.String>;
    abstract toUnicode(input: Input_toUnicode, client: Client): MaybeAsync<Types.String>;
    abstract convert(input: Input_convert, client: Client): MaybeAsync<Types.ConvertResult>;
}

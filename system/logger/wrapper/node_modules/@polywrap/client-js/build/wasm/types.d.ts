...
export interface WrapImports extends WebAssembly.Imports {
    wrap: {
        __wrap_subinvoke: (uriPtr: u32, uriLen: u32, methodPtr: u32, methodLen: u32, inputPtr: u32, inputLen: u32) => Promise<boolean>;
        ...
        __wrap_subinvokeImplementation: (interfaceUriPtr: u32, interfaceUriLen: u32, implUriPtr: u32, implUriLen: u32, methodPtr: u32, methodLen: u32, inputPtr: u32, inputLen: u32) => Promise<boolean>;

...
export declare const deserializePolywrapManifest: (manifest: string, options?: DeserializeManifestOptions | undefined) => import("./0.0.1-prealpha.9").PolywrapManifest;

...
var PluginModule = /** @class */ (function () {
    ...
    PluginModule.prototype._wrap_load_env = function (env) {
        this._env = env;
    };
    PluginModule.prototype._wrap_sanitize_env = function (clientEnv, client) {
        return __awaiter(this, void 0, void 0, function () {
            return __generator(this, function (_a) {
                if (this.getMethod("sanitizeEnv")) {
                    return [2 /*return*/, this._wrap_invoke("sanitizeEnv", clientEnv, client)];
                }
                else {
    ...
    PluginModule.prototype._wrap_invoke = function (method, input, client) {
        return __awaiter(this, void 0, void 0, function () {
            var fn;
            return __generator(this, function (_a) {
                switch (_a.label) {

import { Uri, Client, GetFileOptions, GetManifestOptions, InvokeOptions, InvokeResult } from ".";
...
export declare abstract class Wrapper {
     ...
     */
    abstract invoke(options: InvokeOptions<Uri>, client: Client): Promise<InvokeResult<unknown>>;
    /**
     ...
     */
    abstract getManifest<TManifestArtifactType extends ManifestArtifactType>(options: GetManifestOptions<TManifestArtifactType>, client: Client): Promise<AnyManifestArtifact<TManifestArtifactType>>;
    /**
     ...
     */
    abstract getFile(options: GetFileOptions, client: Client): Promise<ArrayBuffer | string>;
}

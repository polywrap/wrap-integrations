import { QueryHandler, InvokeHandler, SubscriptionHandler, UriRedirect, Uri, PluginRegistration, InterfaceImplementations, Env, WorkflowHandler } from "./";
...
export interface GetManifestOptions<TManifestArtifactType extends ManifestArtifactType> extends Contextualized {
...
export interface Client extends QueryHandler, SubscriptionHandler, InvokeHandler, WorkflowHandler, UriResolverHandler {
    ...
    getManifest<TUri extends Uri | string, TManifestArtifactType extends ManifestArtifactType>(uri: TUri, options: GetManifestOptions<TManifestArtifactType>): Promise<AnyManifestArtifact<TManifestArtifactType>>;

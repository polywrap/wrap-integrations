declare function _exports(config: any): {
    ...
    cp: (...args: [a1: any, options?: (import("ipfs-core/src/components/files/cp").CpOptions & import("..").HttpOptions) | undefined] | [a1: any, a2: any, options?: (import("ipfs-core/src/components/files/cp").CpOptions & import("..").HttpOptions) | undefined] | [a1: any, a2: any, a3: any, options?: (import("ipfs-core/src/components/files/cp").CpOptions & import("..").HttpOptions) | undefined]) => Promise<void>;
    flush: (path: string, options?: (import("ipfs-core/src/utils").AbortOptions & import("..").HttpOptions) | undefined) => Promise<any>;
    ...
    read: (path: any, options?: (import("ipfs-core/src/components/files/read").ReadOptions & import("ipfs-core/src/utils").AbortOptions & import("..").HttpOptions) | undefined) => AsyncIterable<Uint8Array>;
